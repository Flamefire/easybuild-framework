...
class CommandLineOptionsTest(EnhancedTestCase):
        ...
        def run_test(fmt=None):
            ...
            if fmt == 'rst':
                pattern_lines = [
                    ...
                    r'^``%\(cuda_cc_space_sep\)s``\s+Space-separated list of sorted CUDA compute capabilities\s*$',
                ...
                pattern_lines = [
                    ...
                    r'^\s+%\(cuda_cc_space_sep\)s: Space-separated list of sorted CUDA compute capabilities$',
    ...
    def test_try_toolchain_mapping(self):
        ...
        self.assert_multi_regex(patterns, outtxt)
    ...
    def test_show_config(self):
        ...
        self.assert_multi_regex(expected_lines, txt)
    ...
    def test_inject_checksums(self):
        ...
        self.assert_multi_regex(bar_patch_patterns, ec_txt)
    ...
    def test_sanity_check_only(self):
        ...
        self.assert_multi_regex(error_patterns, error_msg)
    ...
    def test_create_index(self):
        ...
        self.assert_multi_regex(patterns, index_txt)
